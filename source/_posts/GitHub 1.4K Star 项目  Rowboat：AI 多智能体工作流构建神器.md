---
title: "GitHub 1.4K Star 项目 | Rowboat：AI 多智能体工作流构建神�?"
permalink: "github-1-4k-star-项目-rowboat-ai-多智能体工作流构建神�?"
...
- �?支持连接 **MCP 服务�?*，轻松导入外部工具（如天气查询、数据库操作），让智能体具备真实业务能力�?

- 3. **�?一键部署，无缝集成**

- �?提供 **HTTP API** 和�?*Python SDK**�? 行代码即可嵌入现有系统，支持企业级高并发调用�?
...
- 2. **访问控制�?*
打开 `http://localhost:3000`，用自然语言描述你的智能体需�?

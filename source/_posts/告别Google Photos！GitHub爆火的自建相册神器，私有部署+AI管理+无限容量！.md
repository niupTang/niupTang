...
permalink: 告别google-photos-github爆火的自建相册神�?私有部署-ai管理-无限容量
...
**大家好，我是牛皮糖！有没有人和我一样，****手机相册堆了3万张照片不敢�?*�?
今天安利一个近期在GitHub狂揽59.1k星的硬核项目——�?*immich👈**
**自建私有化相册服务器**，完爆某度网盘！

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrTNzcdGqfcdtvZaqonDE8TI8Cvn7u1HibAVicv0fWXDDK7m4tkGHfTsXFaXjIGvLXpSfkOC2IyuKK6Q/640?wx_fmt=png&from=appmsg)
...
- �?人脸聚类自动分组（妈�?女友/宠物单独成册�?

- �?CLIP搜索直接描述找图�?蓝色大海的日�?秒出结果�?
...
# 一键启�?
docker-compose up -d`**手机配置**�?

- 1. 应用商店下载Immich客户�?

- 2. 输入服务器地址`http://你的IP:2283`

- 3. 开启「自动备份」享受丝滑体�?

👉 **在线体验**：https://demo.immich.app/photos
账号：`demo@immich.app`
密码：`demo`

### ⚠️ **避坑指南**
- 1. **存储策略**�?
�?不要作为唯一存储！推荐搭配NAS/OSS使用
�?定期检查备份完整�?

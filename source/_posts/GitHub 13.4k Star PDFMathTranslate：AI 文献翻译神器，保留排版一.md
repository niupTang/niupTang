...
- 1. **PDFMathTranslate** 是一款开源的 PDF 文档翻译工具，支持科技论文等 PDF 文件的翻译，保留原文排版，包括公式和图表。
...
- 2. 支持双语对照，保持原有目录结构，兼容多种翻译服务，如 Google、DeepL、Ollama 和 OpenAI 等。
...
`pip install pdf2zh`在命令行中执行翻译指令，在工作目录下生成翻译文档 `example-zh.pdf` 和双语对照文档 `example-dual.pdf`，默认使用 Google 作为翻译服务。

...
    大家好，我是牛皮糖！，今天为大家介绍一个在 GitHub 上备受关注的开源项目：**leaked-system)-prompts**。它像一把"万能钥匙"，揭开了ChatGPT、Claude、Gemini等**18款顶级AI产品的系统提示词黑箱**！项目上线3天狂揽4.5K星，被开发者称为"AI界的维基解密"！
...
- • ChatGPT如何伪装"思考过程"（实际是预设脚本）

- • Claude的"宪法AI"伦理框架实现细节

- • Gemini多模态对齐的隐藏约束条件

- • 包含**ChatGPT-4o完整RLHF训练提示**

- • 曝光**Claude 3拒绝回答敏感问题的128条规则**

- • 解密**Gemini图像审核的900+条禁忌词库**
...
- • `gemini_vision_rules.csv` → 谷歌图像约束库

...
Anaconda 就是可以便捷获取包且对包能够进行管理，同时对环境可以统一管理的发行版本。Anaconda包含了conda、Python在内的超�?80个科学包及其依赖项�?
...
这个是制定环境安装包，如果不�?env_name> 就是安装默认当前使用的环境包
...
TensorFlow，对包对应的�?.12.0版本对应python3.5 windows 的ARM 架构�?4系统的包

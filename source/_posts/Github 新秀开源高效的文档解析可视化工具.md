...
## 项目介绍
**TextIn.com**提供了丰富的可视化和交互功能。这些前端组件基�?*ES6**开发，并采�?*React框架**，为用户带来了极佳的体验�?
...
### **接入API**
首先，你要在textin开通文档解析服务，然后可以在试用工作台点击用户图标，再点击账号与开发者信息（或者登陆后从textin首页->账户与充�?>账号与开发者信息，或者点击https://www.textin.com/console/dashboard/setting中获得api_id和secret_code�?
...
## 项目效果
    说实话这个效果还是挺惊艳我的，我将平时自己分享到社群的一些资�?反向生成对应的markdown ，文件的表格都直接展示出来，很大一部分节约了我的时间�?

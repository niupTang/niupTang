...
permalink: github爆火-ai工程师私藏全能工具箱-�?41-款ai-应用教程
...
### 特色
- •�?*丰富的学习资�?*：提供关于大型语言模型（LLMs）和检索增强生成（RAGs）的深入教程，以及AI智能体的真实世界应用实例�?

- •�?*实践导向**：包含可直接在项目中实施、适应和扩展的示例，让学习者通过实践加深理解和掌握�?

- •�?*面向不同水平的学习�?*：无论是初学者、实践者还是研究人员，都能在这个项目中找到适合自己的资源，进行实验和取得成功�?
...
# 【案例】使�?DeepMind �?Gemma 3、CrewAI �?BrightData 的图书写作流�?
## 工具与技�?
- •�?*Bright Data**：用于抓�?YouTube 视频，获取丰富的多媒体内容，为图书写作提供素材�?

- •�?*CrewAI**：构�?Agentic 工作流程，协调各个任务和步骤，确保整个写作流程的自动化和高效性�?

- •�?*Google DeepMind �?Gemma 3**：作为大型语言模型（LLM），负责生成高质量的文本内容，确保图书的专业性和可读性�?
...
### 设置 Ollama
�?Linux 系统上，通过以下命令设置 Ollama 并拉�?Gemma 3 模型�?

`# 下载并运行安装脚�?
curl -fsSL https://ollama.com/install.sh | sh

# 拉取 Gemma 3 模型
ollama pull gemma3:4b`### 安装依赖�?
...
## 示例输出
以下是�?025 年天文学”工作流程制作的书籍示例，展示了如何将内容整合到文章中：

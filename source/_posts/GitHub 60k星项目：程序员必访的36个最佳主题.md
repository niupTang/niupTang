---
title: "GitHub 60k星项目：程序员必访的36个最佳主�?
permalink: github-60k星项�?程序员必访的36个最佳主�?
...
大家好，我是牛皮糖！作为一名程序员，我们总是需要不断地学习新知识、获取新工具和寻找灵感。最近，我在GitHub上发现了一个超级棒的项目—�?*Best-websites-a-programmer-should-visit**，它汇集�?6个主题程序员应该访问的网站，简直就是我们编程生涯的宝典�?

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrQMuGIibG8X57aG5nyHNYKwR406uFZicicibSIsCnLTJ1GJcFwjPwWNgictQnia2HFooCxIvBgphXjPV83g/640?wx_fmt=png&from=appmsg)

**项目介绍�?*

这个项目由sdmg15发起，目前已经获得了60973颗星。它包含了各种编程资源，从在线课程、技术博客到代码编辑器、API文档等等，几乎涵盖了程序员日常工作和学习所需的所有资源�?
...
- •�?*学习资源**：无论你是初学者还是资深开发者，这里都有适合你的学习资源�?

- •�?*工具和库**：项目中推荐了许多实用的开发工具和库，可以帮助你提高工作效率�?

- •�?*社区和论�?*：通过这些网站，你可以加入到各种编程社区和论坛中，与其他开发者交流经验�?

- •�?*求职和招�?*：这里还有许多求职和招聘网站，对于正在寻找工作机会的你来说非常有帮助�?

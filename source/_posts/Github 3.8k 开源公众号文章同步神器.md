---
title: Github 3.8k 开源公众号文章同步神器
permalink: github-3-8k
date: 2024-10-06 20:24:26
categories:
  - 开源项目
tags:
  - GitHub
...
    大家好，我是牛皮糖！有时候会将公众文章同步到其他平台，可以通过一个开源的浏览器插件实现�?

    一键同步文章到多个内容平台，支持今日头条、WordPress、知乎、简书、掘金、CSDN、typecho各大平台，一次发布，多平台同步发布。解放个人生产力�?

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrS8GvfZasjrrWYcAEJBS3kTvJiaYL1OVB9gJVjqJYu30Pd0iaxCyBVs2HffQFIqiaFee4aN2jZqfMTlQ/640?wx_fmt=png&from=appmsg)

**支持平台**

****

媒体媒体行业状态支持类型微信公众号主流自媒体已支持HTML知乎主流自媒体已支持HTML微博主流自媒体已支持HTMLBilibili通用行业已支持HTML豆瓣通用行业已支持HTML百家号通用行业已支�?
简书通用行业已支持HTML头条号通用行业已支持HTML搜狐号通用行业已支�?
大鱼号通用行业已支�?
一点资讯通用行业已支持HTMLCnblog技术社区已支持Markdown,HTMLCSDN技术社区已支持Markdown,HTML51CTO技术社区已支持Markdown,HTMLSegmentfault技术社区已支持Markdown,HTML掘金技术社区已支持HTML,Markdown慕课�?手记技术社区已支持
开源中国技术社区已支持
Typecho开源CMS已支持HTMLWordPress开源CMS已支持HTML搜狐焦点房地产已支持HTML
...
- 
- 
`      // 使用 window.$syncer 可以检测是否安装插件``      window.syncPost({``        title: this.form.title || this.form.auto.title,``        desc: this.form.desc || this.form.auto.desc,``        content: this.form.content || this.form.auto.content,``        thumb: this.form.thumb || this.form.auto.thumb,``      })`
项目地址�?

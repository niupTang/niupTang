...
3. ADB 自动化控制该项目通过标准的�?*ADB 协议**来实现设备控制，并且**不需�?Root（L）权�?*即可启动，保障了安全性和可靠性。它支持多达 14 种操作�?

4. 其他核心特�? •�?*相对坐标系统�?* 能够试配任意分辨率的屏幕�?
...
2. 相较传统自动化脚本的优势- •�?*内容理解与自适应�?* 传统的自动化脚本会固定坐标，若界面发生变化便会失效。�?Open-AutoGLM **理解内容**，能够自动适应变化�?

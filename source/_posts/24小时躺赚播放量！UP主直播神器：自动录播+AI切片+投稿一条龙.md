...
permalink: 24小时躺赚播放�?up主直播神�?自动录播-ai切片-投稿一条龙
...
    大家好，我是牛皮糖！昨天有朋友问我有没有可以直播智能切片的开源项目，今天给大家分享一个直播流程监�?—�?timerring/bilive 是一个专注于 **B站（哔哩哔哩）直播全流程自动�?*的开源工具，支持从直播录制、弹幕处理、字幕生成到视频切片、投稿的一站式处理�?
...
- �?无GPU模式下，仅需单核CPU+2GB内存即可运行（实测支�?080P录制）�?

- �?支持x86/ARM架构，适配老旧设备（如10年前的电脑）�?

- •�?*AI集成深度**�?

- �?整合Whisper（语音识别）、GLM-4V（视频理解）、Stable Diffusion（封面生成）�?5+模型�?
...
### 💻 四、部署要�?
**配置类型****最低要�?***推荐场景****无GPU模式**单核CPU + 2GB内存
720P录制、基础弹幕渲染
**有GPU模式**4核CPU + T4显卡
4K处理、字幕生成、AI切片
**网络带宽**�?Mbps
...
ARM/x86兼容
项目持续迭代中，计划扩展**自适应码率调节**�?*分布式集群部�?*等进阶功能。适合需长期稳定录制B站直播的用户，但需严格遵守平台版权规则�?

---
title: GitHub 开源项目 | 微调和部署大型语言模型变得简单
date: 2025-05-05 23:32:29
tags:
  - 公众号
  - 原创
categories:
...
    大家好，我是牛皮糖！今天介绍阿里云开源的**ModelScope Swift（ms-swift）**——专为移动端优化的**大模型开发框架**，让开发者能在**本地运行百亿参数大模型**，速度比传统方案快3倍！GitHub上线首周即破**2k Star。**

**
**

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrST3uPiakicPmDrA00Qr5cRqd2qMgI34GmAr9TxcBANYepsofwGibZib1r3bwSiaQGsVaMbPKLeXKT4emA/640?wx_fmt=png&from=appmsg)

ms-swift 是 ModelScope 社区提供的官方框架，用于微调和部署大型语言模型（LLM）和多模态大型模型（MLLM）。目前支持 450+ 大型模型和 150+ 多模态大型模型的训练（预训练、微调、人类对齐）、推理、评估、量化和部署。
![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrST3uPiakicPmDrA00Qr5cRqdvDl80v2Q8mmoRibkvjy9vVjoY0p6N8AWicY84juRia1icia8GgYoMv3yD8g/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrST3uPiakicPmDrA00Qr5cRqdA1HNq2iceSH82Nkw1sUVCB9ibibpV8hKpvN8mavDdtU9w5hlDpiaJDGHxg/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrST3uPiakicPmDrA00Qr5cRqdDNHTnzHlxsbREic4W1zKibmDP0a2lfBDqgiae5cpaXghCka0dNFVjzUAg/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrST3uPiakicPmDrA00Qr5cRqdSs1pxA8VYIX8NpnCGLOCZjI8Bcp7rq7l7qLBDRzIKhx3ib9sgpByo2Q/640?wx_fmt=png&from=appmsg)

...
![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrT0wfwZEs9kfzM3te8sZJIqMNwR0FrftjHFyuUPbjHH3rC8rdR9HWEjBToYmaRraicoxF1U15Exv5w/640?wx_fmt=png&from=appmsg)

****

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrT0wfwZEs9kfzM3te8sZJIqMmuxMuXj9nxrJm9YPDotYkWFsTAb52vgriabSlSL94NaacRiaM0dzMibw/640?wx_fmt=png&from=appmsg)

�?VS Code 和指定的语言使用，如 C++ �?Bash 、Go 、Java 、Python 等语言编辑

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrT0wfwZEs9kfzM3te8sZJIqQXs1nFiaqYD17Zl6qygsvUPuXibUdXscvRBh0lEd15BJHab7scdSfsFA/640?wx_fmt=png&from=appmsg)
...
- 即时MarkDown �?vscode 中编�?markdown 文档，并在键入时立即在浏览器中预览�?

- npm 自动导入模块 插件可在 import 语句中自动完�?npm 模块的导入�?

- 路径自动跳转

- 按特定顺序对文本行进行排�?

![](https://mmbiz.qpic.cn/mmbiz_gif/p1ESIQQvfrT0wfwZEs9kfzM3te8sZJIqc5Ve01pccjMpxYeTg25HFiaWeppZabVNjrTf3Ul06s9feOMicdJv7jHA/640?wx_fmt=gif&from=appmsg)

- 将正在编辑的代码转换成HTML文件，通过浏览器显示并打印�?

![](https://mmbiz.qpic.cn/mmbiz_gif/p1ESIQQvfrT0wfwZEs9kfzM3te8sZJIq3wsteP3FXz5e2FDdYWvrOvT77mb7kUXeLI7fymUAJMncDQrT4eGuCg/640?wx_fmt=gif&from=appmsg)

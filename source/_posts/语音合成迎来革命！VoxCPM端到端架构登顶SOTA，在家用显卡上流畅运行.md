---
title: "语音合成迎来革命！VoxCPM端到端架构登顶SOTA，在家用显卡上流畅运�?
...
- •�?*创新的技术架�?*：与许多主流TTS模型将语音转换为离散符号（token）再进行处理的思路不同，VoxCPM 采用�?*端到端的扩散自回归架�?*。这种方法能够直接从文本生成连续的语音表示，有效避免了信息损失，从而在根源上提升了生成语音的自然度和丰富性�?

- 

- •�?*出色的生成效�?*：根据评测，VoxCPM 生成的语音在**情绪、音色、口音、停顿和韵律**等方面的表现都非常出色，听感上高度接近真人发声。它不仅能根据文本内容自动推断合适的语调风格，还支持**零样本语音克�?*，仅需一段简短的参考音频即可高度还原说话人的音色和情感�?

- 

- •�?*强大的推理效�?*：尽管性能强大，但得益于其小巧的参数规模（0.5B），VoxCPM 对算力要求相对友好。它可以�?*家用电脑**上部署，并支�?*流式合成**，在RTX 4090显卡上可实现高达0.17的实时因子（RTF），满足实时交互应用的低延迟需求�?
...
- •�?*高保真的零样本语音克�?*：这项功能非常实用。你只需要提供一段目标说话人几分钟甚至更短的音频，VoxCPM 就能学习并复刻其独特的音色、口音甚至情感，无需针对该说话人进行额外的模型训练�?

- 

- •�?*处理复杂内容与自定义发音**：模型对中文语境有很好的支持，能够较为准确地处理**数学公式、特殊符�?*的读音。同时，它还支持音素级标记替换，允许开发者对特定词汇的发音进行自定义修正�?

VoxCPM 的这些能力使其在**智能客服、有声读物制作、教育辅导、视频内容创�?*以及**AI智能体（Agent）的语音交互**等领域具有广阔的应用前景，为开发者提供了一个强大的语音合成工具�?

### 🛠�?如何快速开�?
想要体验或使�?VoxCPM，可以通过以下途径�?

---
title: "GitHub 开源项�?| KoalaWiki：两天复刻DeepWiki"
permalink: github-开源项�?koalawiki-两天复刻deepwiki
...
    大家好，我是牛皮糖！今天介绍一款让程序员泪目的神器—�?*KoalaWiki，前面两天DeepWiki 爆火了，可以分析对应的GitHub 文章�?*

但是是闭源项目，今天在GitHub 上面看到一个开源的DeepWiki, 强大的AI驱动代码知识库平台，可以自动分析您的代码仓库，生成详细的文档和见解�?[](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrTaDaBbfdXZNHMh7P6fSG7iaMziab5BbtPQY82PrqQreavorBmDhR6fOCpCDiaicT8McdzE3jiaTjAJ8Rg/640?wx_fmt=png&from=appmsg)
...
- **知识库导�?*直观的目录树结构，便于浏览和查找

- **支持多种模型**集成OpenAI等多种AI模型，灵活配�?

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrTaDaBbfdXZNHMh7P6fSG7iarAHKEfwD0LJeYIFIN3EvJ1LGQCrtDYlWx7BC34lhQsPACicCfdDCgiaQ/640?wx_fmt=png&from=appmsg)

### **�?5分钟极速体�?*
- 2. **添加仓库（支持三种方式）**`# 方式1：直接克隆Git仓库
...
- •�?*新人入职**：@koala "这个微服务怎么调用�? �?直接给出示例

- •�?*合规审计**：自动追踪API变更历史与影响范�?

### **🔗 资源直达**
📌 **GitHub**�?

https://github.com/AIDotNet/KoalaWiki

💻 **在线体验**�?

https://koala.token-ai.cn/AIDotNet/koalawiki

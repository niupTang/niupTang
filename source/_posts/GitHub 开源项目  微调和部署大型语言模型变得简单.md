---
title: "GitHub 开源项�?| 微调和部署大型语言模型变得简�?"
permalink: github
...
    大家好，我是牛皮糖！今天介绍阿里云开源的**ModelScope Swift（ms-swift�?*——专为移动端优化�?*大模型开发框�?*，让开发者能�?*本地运行百亿参数大模�?*，速度比传统方案快3倍！GitHub上线首周即破**2k Star�?*
...
ms-swift �?ModelScope 社区提供的官方框架，用于微调和部署大型语言模型（LLM）和多模态大型模型（MLLM）。目前支�?450+ 大型模型�?150+ 多模态大型模型的训练（预训练、微调、人类对齐）、推理、评估、量化和部署�?

...
![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrQz2313Y7Haopria3ARkRgszgibxUfefGDd2ia0FOPfhMEHBhtPOnZQ2AywAiaD5JEH9Fcz1e8PUDvPCA/640?wx_fmt=png&from=appmsg)
...
MiniCPM-V 2.6 的 **OCR、可信行为、多语言支持和视频理解等视觉能力**。基于其领先的视觉 token 密度，MiniCPM-V 2.6 成为了**首个支持在 iPad 等端侧设备上进行多模态实时流式交互**的多模态大模型。

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrQz2313Y7Haopria3ARkRgszgQUvTjj8cCia3cicZJUXfTxz8gWhL84RU7LsDpZWlbaPtlQibdOQW7Zbg/640?wx_fmt=png&from=appmsg)

### **二、MiniCPM-o 的亮点功能**
**1. 端侧多模态交互先锋**MiniCPM-o 2.6 是其系列中的里程碑版本。它拥有惊人的 8B 参数量，支持视觉、语音和多模态流式交互，达到 GPT-4o-202405 的顶尖水平。
...
- ![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrQz2313Y7Haopria3ARkRgszdPbPo91kHZicSom89N5H7e08CAVOH5feqb7bRLUfz8kmrsHibPxkEFJw/640?wx_fmt=png&from=appmsg)

**2. 语音功能的华丽蜕变**MiniCPM-o 的语音处理实现了革命性提升：
...
- ![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrQz2313Y7Haopria3ARkRgszKUcOGMDibuiaugibAK07TicqP9aPsJLAic1ickQibLy8HHibZgZESreRFqhIqQ/640?wx_fmt=png&from=appmsg)

- 

### **三、快速安装与入门指南**
**1. 简易安装流程**MiniCPM-o 提供了详尽的安装指南，适配 Windows 和 macOS 等主流操作系统：

- • 下载官方安装包。

- • 按照指南一键部署，无需复杂环境配置。

**2. 完善的使用教程**项目团队为用户提供了循序渐进的使用指南：

---
title: "GitHub 61.8k Star：动画数学的魔法�?
...
3b1b/manim 是一个用于创建数学动画的Python库，由著名数学视频博�?Blue1Brown开发。它可以帮助我们以动画的形式展示数学概念，让数学变得更加生动和易于理解。无论是复杂的几何图形，还是抽象的数学理论，manim都能以一种直观的方式呈现出来�?

**如何使用�?*

系统要求是FFmpeg、OpenGL和LaTeX（可选，如果您想使用 LaTeX）。对�?Windows an，需要Pango及其开发头文件。请参阅此处的说明�?***
...
- 
- 
`安装 FFmpeg。``安装 LaTeX 发行版。建议使用MiKTeX 。``安装剩余�?Python 包。``git clone https://github.com/3b1b/manim.git``cd manim``pip install -e .``manimgl example_scenes.py OpeningManimExample``
`
 
...
- 只需要一个URL，就可以导入CMS视频采集站资�?

- 支持多语言（i18n�?

- 提供了丰富的设置，如界面设置、播放器设置�?

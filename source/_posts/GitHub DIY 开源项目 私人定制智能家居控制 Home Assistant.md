---
title: GitHub DIY 开源项目 私人定制智能家居控制 Home Assistant
...
（1）在浏览器中输入127.0.0.1:8123或者通过

 http://homeassistant.local:8123 访问Home Assistant，第一次访问时需要创建账户，如图所示

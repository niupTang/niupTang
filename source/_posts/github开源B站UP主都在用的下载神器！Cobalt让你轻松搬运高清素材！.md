...
permalink: github开源b站up主都在用的下载神�?cobalt让你轻松搬运高清素材
...
## Cobalt 主要特点
- •�?*跨平台支�?*：Cobalt支持通过网页版直接使用，也可以部署在Windows、Mac、Linux等系统上，通过Docker容器运行�?

- •�?*多平台兼�?*：支持下载来自YouTube、Bilibili、TikTok、Instagram、Twitter�?0+主流平台的视频和音频内容�?

- •�?*无广告无追踪**：Cobalt承诺绝不包含广告和用户追踪器，保护用户隐私�?

- •�?*高质量下�?*：支持最�?K视频质量下载，并提供多种视频编码格式和音频比特率选择�?

...
    大家好，我是牛皮糖！做AI 开源项目的公众号主，发很多人会在排版上面浪费大量时间。刚刚好我最近发现了百万大号的编辑都在偷偷用一款**开源Markdown神器**——**无需复杂操作**，直接生成微信官方编辑器兼容的精致排版，**代码块、数学公式、多图上传全搞定**，今天必须安利给你们！”
...
**👉 这款工具一次性解决所有问题：**
✅ **Markdown语法直接变微信样式** – 像写笔记一样简单
✅ **支持LaTeX公式** – 理工科博主狂喜
✅ **快捷键一键美化**（Alt+Shift+F秒排版）
✅ **色盘取色+深色模式** – 整体配色5秒更换
...
- 1. **开源免费** – 不用交年费，企业级功能白嫖

- 2. **图床自定义** – 兼容七牛云/阿里云OSS，传图不压缩

- 3. **深色模式** – 熬夜写文护眼必备（实测省电30%！）
...
- 1. **电脑端访问**：https://github.com/doocs/md

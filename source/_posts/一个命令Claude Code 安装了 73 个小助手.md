---
title: "一个命令Claude Code 安装�?73 个小助手"
permalink: claude-code-73
...
大家好，我是牛皮糖！最近从各种付费的编�?AI 工具转型到了 Claude Code
[AI 编程工具横评：字�?Trae、腾�?CodeBuddy、阿�?Qoder，谁更胜一筹？](https://mp.weixin.qq.com/s?__biz=MzkyNDYyODg0MQ==&mid=2247491672&idx=1&sn=731bb338b89e8852006b96b5eed14466&scene=21#wechat_redirect)
...
也在全网找如何优雅的使用 Claude Code , 发现 Claude Code 不亏是最�?AI 编程工具 ，今天在GitHub 上看到一款这个名�?agents 的仓库是一个为 Claude Code 打造的综合性生产级插件系统，专注于智能自动化和多代理协同工作流�?
...
### **核心组成**
- •�?*63 个专注插�?*：按单一用途设计，优化�?token 占用，支持按需安装，避免资源冗余�?
...
- •�?*85 个专业代理（Agents�?*：覆盖架构设计、编程语言、基础设施、质量保障、数�?AI、业务运营等多个领域的专家角色�?

- •�?*47 个代理技能（Skills�?*：模块化知识包，采用渐进式披露机制，仅在需要时加载专业知识，提升效率�?

- •�?*15 个工作流编排�?*：支持多代理协同处理复杂任务（如全栈开发、安全加固、机器学习管道等）�?

- •�?*44 个开发工�?*：包括项目脚手架、安全扫描、测试自动化、基础设施搭建等实用工具�?
...
- •�?*开发领�?*：涵�?Python、JavaScript/TypeScript、Java、Rust 等编程语言，以及前后端开发、API 设计（REST/GraphQL）、区块链/Web3 等�?

- •�?*基础设施**�?Kubernetes 运维、云架构（AWS/Azure/GCP）、Terraform 基础设施即代码、GitOps 工作流等�?

- •�?*质量与安�?*：代码审查、安全审计、性能优化、错误诊断、技术债务清理等�?

- •�?*业务与运�?*：事件响应、团队协作、市场内容生成、SEO 优化、量化交易等�?
...
### **使用方式**
- 1. **添加市场�?*：通过命令 `\plugin marketplace add wshobson/agents` 将仓库添加到 Claude Code�?

- 2. **安装所需插件**：例如：`# 安装 Python 开发插�?
...
### **架构特点**
- •�?*模块化设�?*：每个插件独立封装，包含专属代理、命令和技能，确保低耦合、高可组合性�?

- •�?*高效资源利用**：平均每个插件仅包含 3.4 个组件，遵循 Anthropic 推荐�?2-8 组件模式，减�?token 消耗�?

- •�?*清晰的目录结�?*：插件按功能分类存放，文档齐全（包括插件参考、代理指南、技能说明等）�?

---
title: "微软开源扔出AI“深水炸弹”：CPU都能�?000亿参数大模型�?
permalink: 微软开源扔出ai-深水炸弹-cpu都能�?000亿参数大模型
...
大家好，我是牛皮糖！在研究小模型的伙伴有福气了，微软开源了 一�?1 Bit 的大模型。今年的 4�?5日，微软研究院正式开源了BitNet项目，这是一个专�?比特大模型设计的推理框架。它让AI模型**在CPU上的运行速度提升了最�?�?*，能耗降低超�?0%，甚至可以在普通笔记本电脑上运行千亿参数的大模型�?
...
## 什么是BitNet？三进制LLM的突�?
BitNet项目的核心是BitNet b1.58 2B4T——全球首个开源的**原生1比特大型语言模型**。这款模型拥�?0亿参数，基于4万亿标记训练而成�?
...
与传统LLM使用16位或32位浮点数存储权重不同，BitNet b1.58采用了一种革命性的方法�?*将权重参数量化为三元�?*{-1�?0�?+1}�?

由于使用了三种值，从信息论角度看，每个参数仅需�?.58比特表示，因此得名b1.58�?

这种量化方法带来了多重好处：模型内存占用骤降�?*0.4GB**，仅为同类全精度模型�?/5�?/12�?
...
BitNet框架最大的突破是让大模型摆脱对高端GPU的依赖。根据微软的实验，BitNet可以�?*单个CPU上以每秒5-7个token的速度运行1000亿参数模�?*，基本等同于人类阅读速度�?

在x86 CPU上，推理速度提升�?*2.37�?.17�?*，在ARM CPU上提�?*1.37�?.07�?*。能耗更是惊人地降低�?*55.4%�?2.2%**，为AI在移动设备和边缘计算场景的应用打开了大门�?
...
开源不久，微软研究团队又火速推出了**BitNet v2**，首次实现了�?比特LLMs�?*原生4比特激活值量�?*�?

通过引入哈达玛变换处理激活值异常分布问题，BitNet v2�?*性能几乎0损失**的情况下，进一步降低了内存和计算成本�?
...
�?*大幅降低了AI应用的门槛和成本**，让更多人可以参与到AI应用的创新中来�?

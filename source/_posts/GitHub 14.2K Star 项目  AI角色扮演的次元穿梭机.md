...
    大家好，我是牛皮糖！在这个AI对话百花齐放的时代，你是否也想打造属于自己的智能角色剧场？今天要给大家种草的这款开源神器——**SillyTavern**，堪称AI角色扮演界的"瑞士军刀"！它能让你轻松搭建个性十足的虚拟聊天室，目前已在Github狂揽14.2K stars，绝对是剧情党/跑团爱好者的秘密武器！🚀

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrQsZrMFsSZibWOc3BAZtjXx2ABcIvJhtuOMibVYUDGEXsiaxiaiaBpq2cq6GGEfW72QkUnzaLMYxIDXQ0w/640?wx_fmt=png&from=appmsg)

### 🌟 项目速览
SillyTavern 是一个基于Web的AI角色扮演平台，就像给你的想象力装上火箭引擎！无论你是想：

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrQsZrMFsSZibWOc3BAZtjXx2C3calJE0I16lvbU3uBhdiaa2ZKbJicNano44hAUdMMAaEcHl39yiaaibicg/640?wx_fmt=png&from=appmsg)
...
- • 🖥️ 在手机/电脑/平板上即开即用
它都能完美胜任，堪称二次元与三次元之间的任意门！

### 🔥 核心亮点
- **角色卡**：角色卡是设置LLM行为的提示集合，用于持久对话

- **高级设置**：包含许多社区制作的预设，可以自定义文本生成的各个方面

- **世界信息**：创建丰富的背景知识或在角色卡上保存代币

- **群聊**：多角色房间，角色可以互相交谈

- **UI定制**：主题颜色、背景图片、自定义CSS等丰富的UI选项

- **用户画像**：让用户了解你，增强沉浸感

- **内置RAG**：将文档添加到聊天中供AI参考

- **聊天命令系统**：内置脚本引擎和扩展功能

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrQsZrMFsSZibWOc3BAZtjXx2ejWzs1cfZuLmzicxsxKuNLTF3ot75RkbLEQI5BEx4vCyeO1LtljqTvA/640?wx_fmt=png&from=appmsg)

👉 **传送门**：
Github主页：https://github.com/SillyTavern/SillyTavern

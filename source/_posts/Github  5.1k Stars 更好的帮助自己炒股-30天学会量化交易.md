---
title: "Github  5.1k Stars 更好的帮助自己炒�?30天学会量化交�?"
permalink: github-5-1k-stars-30
...
    大家好，我是牛皮糖！A 股依旧给力的大涨，今天去看一下GitHub 上面有哪些小项目适合赚钱的。一个有5.1k Star�?项目30天掌握量化交�?(持续更新)。包含数据分析、基金监控、K线形态、还有数据源�?

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrR4xyp7kgVYOjyFdvHiaYnBSNKVHuiaf7UhhGrxhe7SoBV0rve3IGY09pSKQoNhEwGr6RSWl899lUTw/640?wx_fmt=png&from=appmsg)
...
**![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrR4xyp7kgVYOjyFdvHiaYnBSJxzVe5SsYFYlEKR3Ekicx4peibDsuneqk6ONbAzXfS8STqX5nlxiadsuw/640?wx_fmt=png&from=appmsg)
**

### 已有�?
### 

### datahub/black_list_sql.py 记录A股市场上所有有黑历史的股票名单，并存入数据�?
- big_deal.py 监控每天A股市场上的大单交�?

- bond_monitor 可转债监�?

- ceiling_break.py 新股一直板开板后多少天能够重新回到开板价�?

- delivery_order.py 把交割单导出到Mysql，便于查找某只清仓股的操作历史痕迹，对自己的操作记录一目了�?

- fetch_each_day.py --获取每天换手率前50的热门股

- filter_stock.py 通过不同的因子策略选股，常见的如市盈率，流通量，股东数，基金持股数�?

- foreign_exchange.py 获取美元汇率的每天走势并存入Mysql

- get_break_high.py --获取当天�?0天新高的股票。为什么不获取60天呢？因为大家都在用，用的人多了就不准了�?

- ipospeed.py 统计每天IPO新股发行速度与大盘的相关�?

- ipo_stock.py 新股统计

- jisilu.py 获取集思录的可转债行�?

- jubi.py -获取国内山寨币平台的实时数据

- new_stock_break 分析新股的开板时�?

- new_stock_fund 打新基金获取，并选出中签科创板的基金

- pledgeed_validation.py 股权质押数据整理

- push_msn.py -短信提醒自己 设定的某个股票价格或者涨幅达到自�?要求

- relationship_case.py 每个月的解禁股与大盘指数的关�?

- select_stock.py - 选股策略�?根据自己的经验选出来的个股�?

- SPSIOP_PRICE.py - 华宝油气估�?通过爬虫获取数据然后计算
...
- strategy_verify.py -获取雪球的即时交易策�?

- win_or_lost_each_day.py --评估自己每天每只股票的盈亏情�?完成�?00%
...
如果不能出去的，我已经帮你下好源码了，关注公众号回复量化交易�?

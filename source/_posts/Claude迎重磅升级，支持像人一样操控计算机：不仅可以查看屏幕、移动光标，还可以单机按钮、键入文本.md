---
title: Claude迎重磅升级，支持像人一样操控计算机：不仅可以查看屏幕、移动光标，还可以单机按钮、键入文本！
permalink: "claude迎重磅升�?支持像人一样操控计算机-不仅可以查看屏幕-移动光标-还可以单机按�?键入文本"
date: 2024-10-23 16:31:00
categories:
  - AI编程
tags:
  - 自动化
...
    大家好，我是牛皮糖！昨天 Claude 3.5 重量级更新， 平时我们都想通过RPA 来实现的人机交互自动化，现在AI 就能胜任了�?

Claude 3.5 Haiku 和升级款�?Claude 3.5 Sonnet 都来了。Claude 3.5 Sonnet 不仅编程能力更强，还带来全新功能computer use（计算机使用）， Claude 现在支持像人类一样操作计算机,可以遵循用户的命令在计算机屏幕上移动光标，点击相关位置，并通过虚拟键盘输入信息，模拟人们与自己计算机的交互方式�?

![](https://mmbiz.qpic.cn/mmbiz_jpg/p1ESIQQvfrQicpgZOt6dMcFOh6Y8X6IEp3Lql3ibiaGt7wtYZsVPcDfqDO8gTG0DAQJ4KsOWSia64zQYX6ibgSzaWuA/640?wx_fmt=jpeg&from=appmsg)

升级�?Claude 3.5 Sonnet 现在就可以使用了。computer use测试版也开放使用�?

![](https://mmbiz.qpic.cn/mmbiz_jpg/p1ESIQQvfrQicpgZOt6dMcFOh6Y8X6IEpYI3NgDKlacQIT2x8s4bKvia7STZHEXPlH9ueEHL1ycEe3ic0I5jxtg2Q/640?wx_fmt=jpeg&from=appmsg)

进化后的Claude 3.5 Sonnet堪称最强推理模型。它在各个方面得到了全面显著的提升，尤其是业界领先的编码能力�?

![](https://mmbiz.qpic.cn/mmbiz_jpg/p1ESIQQvfrQicpgZOt6dMcFOh6Y8X6IEpQPkdVF92eURAJqPhzRK5zORva4zl0z6W3q0shAKHmOId8wJibOPDong/640?wx_fmt=jpeg&from=appmsg)

**甚至，Claude现在能够像人类一样操作计算机，不仅可以查看屏幕、移动光标，还可以单机按钮、键入文本！**

目前，Claude 在以与人相同的方式使用计算机的模型中处于最先进水平——也就是说，通过查看屏幕并根据屏幕内容采取行动。在一个旨在测试开发人员让模型使用计算机的评估（OSWorld）中，Claude 目前获得�?14.9% 的分数。这远未达到人类水平的技能（通常�?70-75%），但远高于同一类别中排名第二的 AI 模型获得�?7.7%�?
...
![](https://mmbiz.qpic.cn/mmbiz_gif/p1ESIQQvfrQicpgZOt6dMcFOh6Y8X6IEpiae0BcpKOpTJdDjIfjCLOa4Cdz00l3ynxLpbCrnZQLXibJlDKSq9KRGg/640?wx_fmt=gif&from=appmsg)

金门大桥和用户居住地有多远呢？Claude会自己打开地图查找距离�?

![](https://mmbiz.qpic.cn/mmbiz_gif/p1ESIQQvfrQicpgZOt6dMcFOh6Y8X6IEp0PiaO1oaesKHFdcEomNULJtdMKzYQaQDPwnCibOMZyeSz5eWpfbIPeJw/640?wx_fmt=gif&from=appmsg)

开发者展示出Claude如何操控了自己的笔记本电脑，丝滑地完成了一个网站编程任务�?

首先，Claude在小哥的Chrome浏览器中导航到了Claude.ai，并且让Claude为自己创造了一�?0年代主题的个人主页�?

只见它自己输入网址，键入提示，向另一个Claude发出请求�?

![](https://mmbiz.qpic.cn/mmbiz_gif/p1ESIQQvfrQicpgZOt6dMcFOh6Y8X6IEpLMyAEBSxTWq650iaQVB0OEl2lf4XspIpvmuQF3fgbNd0wNv5R2IJJrA/640?wx_fmt=gif&from=appmsg)

假设我们需要填写一份来自蚂蚁设备公司的供应商请求表，但需要填写的数据散步在电脑的各个角落，Claude能帮我们完成吗？

只见它开始截取操作者的屏幕截图，并且很快发现：蚂蚁设备公司并不在表格中�?

![](https://mmbiz.qpic.cn/mmbiz_gif/p1ESIQQvfrQicpgZOt6dMcFOh6Y8X6IEp40Y7gF5iaXwtgkCGwyIT2NeXUdSg97o0VL4HAibDBaalia4JicXCjYKaXA/640?wx_fmt=gif&from=appmsg)

这时，它立刻切换到CRM系统中，去搜索这个公司。找到后，它开始滚动页面，查找填表所需的所有信息，然后提交了表格。这也就意味着，我们工作中许多不得不做的繁琐事项，都可以交由Claude代劳了！

![](https://mmbiz.qpic.cn/mmbiz_gif/p1ESIQQvfrQicpgZOt6dMcFOh6Y8X6IEpayrV808xQICEPdnfNHQzSYgRicY6168ZJvBREOS5eOxia6Nyib0YqCZNw/640?wx_fmt=gif&from=appmsg)

在各项行业基准测试中，升级版Claude 3.5 Sonnet性能得到了全方位提升。特别是，智能体编码、工具使用任务中取得显著突破�?

在编码能力方面，它在SWE-bench Verified测试中，性能�?3.4%大幅提升�?9.0%�?
...
![](https://mmbiz.qpic.cn/mmbiz_gif/p1ESIQQvfrQicpgZOt6dMcFOh6Y8X6IEp3KFfUb6wGZELLicN6dSWeTmtWYfcMRZg5VE7SlkeRoW75fiaV1k6mhaA/640?wx_fmt=gif&from=appmsg)

总之，Claude如今的表现让人对未来充满期待：AI操作电脑的能力将神速进步，那一天，软件开发小白都能轻松使用它�?

转载于：

**Claude迎重磅升级，支持像人一样操控计算机：不仅可以查看屏幕、移动光标，还可以单机按钮、键入文本！(baidu.com)**

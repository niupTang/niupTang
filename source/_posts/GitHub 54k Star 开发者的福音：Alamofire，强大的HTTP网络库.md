---
title: "GitHub 54k Star 开发者的福音：Alamofire，强大的HTTP网络�?
permalink: github-54k-star-开发者的福音-alamofire-强大的http网络�?
...
### **组件�?*
为了�?*Alamofire**专注于核心网络实现，Alamofire软件基金会还创建了一些组件库，比�?*AlamofireImage**�?*AlamofireNetworkActivityIndicator**，这些库�?*Alamofire**生态系统带来了额外的功能�?
...
如果你不想使用依赖管理器，也可以手动集成**Alamofire**。只需�?*Alamofire.xcodeproj**拖入你的项目中，然后在“嵌入式二进制文件”中添加**Alamofire.framework**即可�?

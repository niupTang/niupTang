---
title: "Github 开源Java自动投递工�?"
permalink: github-java
...
    大家好，我是牛皮糖！因为我自己是Java 开�?在找工作，去GitHub 上找了一款自动投递工具，发现这款还是不错的。只需要简单配置直接就可以运行。BOSS 直聘每天投�?00份轻轻松松�?
...
- 🛠�?易于配置：集中化配置，只需修改配置文件即可自定义筛选条件，轻松上手�?

- 🔄 持久登录：支持超�?Cookie 登录，大部分平台每周仅需扫码一次，减少重复操作�?
...
- 每个包下的Scheduled文件，即使单独针对平台的定时投递，例：BossScheduled.java ，就是boss平台每天定时投�?

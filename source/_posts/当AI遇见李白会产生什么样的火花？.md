...
### 🚀 项目简�?
**meet-libai** 是一个使�?LangChain 构建�?AI 智能体项目，它通过 Prompt、工具链、记忆等模块，打造了一个能和用户诗意对话的“数字李白”�?

- �?🌟 核心目标：与「李白」对话，体验唐诗之美�?

- �?💡 技术核心：LangChain + LLM + 自定�?Prompt + 多轮记忆

- �?🔧 支持框架：支�?OpenAI / ChatGLM3 等多种大模型，适配多种后端部署�?
...
支持 gradio 界面演示
前后端分离、易部署
### 📜 LangChain 智能体开发提示词（基�?meet-libai�?
...
`�?AI 李白添加记忆模块，支持上下文记忆与情绪保持`工具扩展
`添加一个古诗查询工具，可用于引用其他诗人诗句`调试优化
`开�?verbose 模式，分析每轮对话的推理链路`### �?项目适用人群
- �?🎓 语言模型入门者：学习 LangChain 如何快速构建人格型 Agent�?

- �?🧑‍�?AI 内容创作者：�?AI 创作古诗、角色互动等�?

- �?💻 LangChain 高阶玩家：研�?Prompt 工程+记忆管理+多工具集成实践�?

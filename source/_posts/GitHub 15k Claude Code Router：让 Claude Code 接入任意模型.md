...
permalink: github-15k-claude-code-router-�?claude-code-接入任意模型
...
大家好，我是牛皮糖！最近看到Claude Code 很火，但是很多限制导致国内没办法接入，我在GitHub 上看到对应的开源项�?——  Claude Code Router�?

它由 musistudio 推出，让你能在使�?Claude Code 时灵活切�?AI 模型，抛开 Anthropic 限制，享受自由又高效的开发体验�?
...
- •�?*配置可扩�?*：支持自定义请求/响应转换；还能嵌�?GitHub Actions，自动化触发任务 �?
...
- �?支持�?Provider（如 OpenRouter、DeepSeek）及�?API 地址�?Key
...
- �?路由规则，定义哪个模型用�?default、think、longContext 等场景�?
...
优势
描述
**打破壁垒**不再依赖 Anthropic，使用更多模型平�?
**自由路由**任务类型区分清晰，模型分配高效精�?

---
title: "GitHub 142 k Stars 开源的技巧、单行命令工具等的集�?"
permalink: "github-142-k-stars-开源的技�?单行命令工具等的集合"
...
    大家好，我是牛皮糖！在GitHub 上面 开到一款属于程序员应该拥有�?技巧、博客和工具集合，以前在做服务器部署的时候经常遇到服务不通，但又没有什么办法，在上面我就发现好几款运维工具。这个存储库是作者每天在工作中使用的各种材料和工具的集合。它包含许多有用的信息，收集在一起。对作者自己来说，这是一个宝贵的知识来源，还会经常回顾�?

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrRx8KYsqRGoUuqnxVcCZK39VotpBk8AgzLkQibxxPWKe2GWicrenckTn2UsPzibliaSNPeG2BW6YjUmeQ/640?wx_fmt=png&from=appmsg)

    确实适合所有人。在这里每个人都能找到自己喜欢的口味。但说实话，它面向系统和网络管理员、DevOps、渗透测试人员和安全研究人员�?***
...
![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrRx8KYsqRGoUuqnxVcCZK39JVv0O3YLwd2rG3QibicWkicMvEQZ5Ricyqwx9XLdVbmZEmticygiajUicQviaA/640?wx_fmt=png&from=appmsg)

*知识是强大的，但要谨慎使用它�?****

*这里的工具有很多，但是针对于如何合理的使用还需要谨�?

*上面还是有很多安全、黑客相关的博客和链接�?

...
permalink: "github爆款-这个ai提示词神�?让你的deepseek秒变职场外挂"
...
**“别人的AI能写周报、做PPT，你的AI只会回‘好的’？**

最近发现，所有AI高手都在偷偷用同一个神器—�?*Prompt Optimizer**，它能让你的垃圾提示词秒变黄金指令！不用学任何技巧，AI自己就能帮自己优化！

——不会写提示词？让AI自己优化自己�?

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrTuDgwEmawnM4RJiaiayvoX5ONaARvyCknlwKibHtUOQKpBkwmhWbS7Z97xrCttjot4XTIPGBRDrPxkg/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrTuDgwEmawnM4RJiaiayvoX5OociajJut6JOgqCjsUSqaXy3jPibD6tibACg5QesHzMoq5gao7zQGiaCRfQ/640?wx_fmt=png&from=appmsg)

### **核心痛点�?*
**🐾 铲屎官们，你还在这样浪费AI会员吗？**- •�?*场景1**：输入“写篇文章�?�?AI给你200字废话文�?

- •�?*场景2**：手动调教半小时 �?结果下次提问又失�?

- •�?*场景3**：换个大模型 �?之前积累的提示词全作�?

- 

- ![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrTuDgwEmawnM4RJiaiayvoX5OhAzKNCloYBS1EavXuPibDWeicgpb3HKSFv6BXZlFShdI8bB7J7BVcEwQ/640?wx_fmt=png&from=appmsg)
...
- 3. 获得完美指令�?
“你是一名资深项目经理，请用Markdown格式生成包含：本周进度（数据量化）、卡点分析（分技�?协作）、下周计划（SMART原则）的周报�?

### **神器能力拆解�?*
**🔧 这不是工具，是AI的“自我修养”培训班�?*

- •�?*自诊自疗**：自动识别模糊指令，补全专业术语（比如加上“用金字塔结构输出”）

- •�?*模型翻译�?*：把给GPT-4的提示词自动适配Gemini/DeepSeek

- •�?*记忆大师**：保存成功提示词，建立你的专属《AI驯服手册�?

**🛡�?更放心的设计�?*

- �?数据直连AI厂商 �?你的API密钥连开发者都看不�?

- �?浏览器插件版 �?公司电脑也能偷偷用（摸鱼党狂喜）

### **3秒上手教程：**
**🐱 Docker党：**

`docker run -d -p 80:80 --name ai-butler linshen/prompt-optimizer`**🦊 Chrome党：**

---
title: "Github 技术平权开源两周获�?6 K Stars，要普通人也能打破信息差！�?
permalink: github-技术平权开源两周获�?6-k-stars-要普通人也能打破信息�?
...
大家好，我是牛皮糖！在推荐算法时代，我们一直在一个信息茧房里面， 今天�?GitHub 上面看到一款开源的智能体�?*BettaFish** 志在帮助普通人打破信息�?�?
...
- 1. **AI驱动的全域监�?*：AI爬虫集群7x24小时不间断作业，覆盖微博、小红书、抖音、快手等10+国内外关键社媒，实时捕获热点内容并深入海量用户评论�?

- 

- 2. **超越LLM的复合分析引�?*：依�?类专业Agent，融合微调模型、统计模型等中间件，通过多模型协同确保分析结果的深度、准度与多维视角�?

- 

- 3. **强大的多模态能�?*：突破图文限制，可深度解析短视频内容，精准提取搜索引擎中的结构化多模态信息卡片�?

- 

- 4. **Agent“论坛”协作机�?*：为不同Agent赋予独特工具集与思维模式，引入辩论主持人模型，通过“论坛”机制实现链式思维碰撞与辩论，避免单一模型局限�?

- 

- 5. **公私域数据无缝融�?*：不仅分析公开舆情，还提供高安全性接口，支持内部业务数据库与舆情数据无缝集成�?

- 

- 6. **轻量化与高扩展性框�?*：基于纯Python模块化设计，实现轻量化、一键式部署，代码结构清晰，便于集成自定义模型与业务逻辑�?

## 系统架构
### 主要组件
- •�?*Insight Agent**：私有数据库挖掘代理，负责私有舆情数据库深度分析

- •�?*Media Agent**：多模态内容分析代理，具备强大多模态处理能�?

- •�?*Query Agent**：精准信息搜索代理，具备国内外网页搜索能�?

- •�?*Report Agent**：智能报告生成代理，内置模板的多轮报告生�?

- •�?*ForumEngine**：论坛引擎，实现Agent间的协作与讨论机�?
...
- 2. 并行启动：三个Agent（Query、Media、Insight）同时开始工�?

- 3. 初步分析：各Agent使用专属工具进行概览搜索

- 4. 策略制定：基于初步结果制定分块研究策�?

- 5. 循环阶段：论坛协作与深度研究（多轮循环）

- 6. 结果整合：Report Agent收集所有分析结果和论坛内容

- 7. 报告生成：动态选择模板和样式，多轮生成最终报�?
...
- • `SentimentAnalysisModel/`：情感分析模型集合，包括多种微调模型和传统机器学习方�?

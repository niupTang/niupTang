...
![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrSLiajrE69gkjag0wiaBzwlPvIF7OS8rK47Jib1BQ08mwSu1PcGo8iaicDGuDwibJCZZNnWTjGGOsRBHoZw/640?wx_fmt=png&from=appmsg)

## 功能特点
- • **高度可定制**：shadcn-ui的组件设计非常灵活，你可以根据自己的需求调整样式、行为和交互，完全不用担心被框架限制。

- ![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrSLiajrE69gkjag0wiaBzwlPvuiaC5f8lXqSRBpo1XdMBXY8bMVicPdkzHagftlVJC1D9FaGfZY8YzYMA/640?wx_fmt=png&from=appmsg)

- • **丰富的组件库**：它包含了按钮、输入框、导航栏、模态框等40+基础组件，覆盖了常见的UI场景。

- ![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrSLiajrE69gkjag0wiaBzwlPvgI6kpIZ3JD2859VX3JoGvAgtJk1tU8EV4eTaCHTpelian1AFoKTP5Qw/640?wx_fmt=png&from=appmsg)

- • **响应式设计**：组件具备良好的响应式设计，能够适配不同屏幕尺寸，让你的应用在桌面、平板、手机上都能完美展示。

- ![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrSLiajrE69gkjag0wiaBzwlPviamNHSHBNqyhh6YeblRfFl6l6GMlmOm9aicp4cCz7sOtia58EGm7w4OzA/640?wx_fmt=png&from=appmsg)
...
`npm install shadcn-ui`或者使用Yarn：

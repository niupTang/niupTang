---
title: "GitHub 30.5K Star 项目 | AI工具设计的藏宝图：揭�?大顶级AI助手的系统提示词"
...
    大家好，我是牛皮糖！今天要介绍一个震撼AI圈的开源项目—�?*system-prompts-and-models-of-ai-tools**，它像一�?AI工具设计百科全书"，曝光了Cursor、Devin�?款顶级AI助手�?*完整系统提示词和内部配置**，GitHub狂揽30.5K星，被开发者誉�?提示工程领域的圣�?�?
...
### **🔥 项目核心价�?*
- 1. **💎 行业机密大公开**
包含6500+行未公开的System Prompt，覆盖Cursor、Devin、Manus�?款明星工具，揭示AI如何�?调教"成专业助手�?

- 2. **🛠�?提示工程实战手册**
�?*角色定义**�?*工具调用规范**，完整展示AI工具的设计逻辑，比如：
...
### **🔍 深度亮点解析**
**1. Cursor�?心理暗示�?**- •�?*角色洗脑**：开篇强�?你是全球最强IDE中的AI助手"，强化自我认�?
...
**2. Devin�?工程师思维"**- •�?*人设打�?*：自�?真正的编程奇�?，强调代码简洁性和迭代能力
...
**3. Manus�?多面手策�?**- •�?*信息检索优先级**：API数据 > 网络搜索 > 模型知识

- •�?*写作强迫�?*：要求内�?至少几千�?，必须分段避免列�?

- •�?*代码洁癖**：禁止直接执行代码片段，必须保存为文�?
...
- • `manus_modules.md`：复杂任务分解指�?

- 3. **安全警示**：使用配套的ZeroLeaks工具检测自有AI系统漏洞

### **💼 企业级应用场�?*
- •�?*AI初创公司**：直接复用成熟提示框架，加速产品开�?
...
### **⚠️ 风险与争�?*
- 1. **法律灰色地带**：部分内容可能涉及商业秘�?

- 2. **安全悖论**：项目本身提醒AI公司防范提示词泄�?

- 3. **社区争议**：有开发者质�?禁用基础命令"等规则的实际效果

---
title: "GitHub 开�?xiaohongshu-mcp：当AI智能体学会自动发小红书，内容创作要变天了�?
permalink: github-开�?xiaohongshu-mcp-当ai智能体学会自动发小红�?内容创作要变天了
...
大家好，我是太阳鸟！不知道大家有没有想过把微信文章内容精华然后转为图文，发布到小红书上面？今天在GitHub 上面看到一个开源的 MCP 项目，是由国内的个人开发者用 AI 开发的一�?小红�?MCP�?
...
如果它让Claude、Cursor等AI助手获得�?*直接操作小红书的能力**，你可以用自然语言命令AI帮你发笔记、搜内容、看推荐流！

## 🚀 项目简介：AI与小红书的完美结�?
**xiaohubgsu-mcp** 是一个基�?*Model Context Protocol (MCP)** 协议的开源项目，简单说就是为AI智能体添加了"操作小红�?的技能。这个项目在GitHub上已经获得了不少关注，成为AI自动化领域的一个创新案例�?

最厉害的是，它不是简单的自动化脚本，而是真正实现�?*AI智能体与小红书平台的深度集成**。你可以用自然语言告诉AI�?帮我找找最近流行的露营装备笔记，总结一下爆款特�?，AI就能自动调用这个项目的功能去执行搜索和分析！
...
- •�?*多账号支�?*：可以配置多个小红书账号切换使用

- •�?*本地存储**：登录信息完全保存在本地，保障账号安�?
...
### 案例1：内容创作者的效率神器
`# 传统方式：手动操�?0分钟
1. 拍照修图 �?2. 写文�?�?3. 添加标签 �?4. 发布笔记

# 使用xiaohongshu-mcp：AI一键完�?
AI命令�?帮我把这组咖啡厅照片发小红书，文案要文艺清新�?`### 案例2：营销人员的竞品分�?
```
`# 自动监控竞品动�?
...
```
## ⚠️ 重要使用提醒
- 1. **遵守平台规则**：小红书对自动化操作有严格限制，请合理使用频�?

- 2. **账号安全第一**：建议使用小号测试，避免主账号风�?

- 3. **技术门槛存�?*：当前版本需要一定的技术背景来配置
...
对于**内容创作�?*，它大幅提升了内容生产和发布的效率； 对于**营销人员**，它提供了数据驱动的竞品分析和趋势洞察； 对于**AI开发�?*，它展示了如何将AI能力与实际业务场景深度结合�?
...
老秦这个AI私域赚钱星球�?2 一年，一万个星球中，连续 4 个月排名�?3，很多超级大佬亲自推荐，性价比极高，很多人在这里赚到几千上万�?

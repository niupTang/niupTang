...
在大模型和智能体爆火的当下，不少开源项目要么只�?SDK，要么只提供框架，真正能做到**开箱即�?*的完整产品却凤毛麟角。很多时候，开发者还要自己拼拼补补，才能跑起来一个像样的 Agent 应用�?
...
- �?它是一�?*端到端完整多智能体产�?*，即开即用，还支持二次开发�?

比如你输入一句话�?👉「给我做一个最近美元和黄金的走势分析�?

JoyAgent-JDGenie 可以直接产出 **网页版报�?* 或�?*PPT 文档**，而不是只返回一堆文本�?
...
## �?功能亮点
- •�?*完整产品，开箱即�?* 提供前端、后端、框架、引擎、核心子智能体（报告、代码、PPT、文件等），真正的产品级体验�?

- •�?*多智能体框架协议** 支持 **React 模式**�?*Plan & Executor 模式**，让不同任务都能灵活调度�?

- •�?*�?Agent 可插�?* 想要天气查询？报表生成？文件总结？直接新增一个小智能体挂载即可�?

- •�?*多种交付样式** 支持 **HTML、PPT、Markdown** 输出，满足不同场景需求�?

- •�?*高性能执行引擎** 内置高并�?DAG 调度，能保证复杂任务流畅执行�?

- •�?*创新�?*

- •�?*多层级多模式思�?*：既能做整体规划（work level），也能细化执行（task level）�?

- •�?*跨任务记�?*：类似“记忆体”，能跨任务学习相似历史，提升稳定性�?
...
超越�?OWL（CAMEL）、Smolagent（Huggingface）、AutoAgent（港大）等知名开源产品�?

相比 SpringAI（依赖阿里云百炼）、Coze（依赖火山引擎），JoyAgent-JDGenie **更轻量，不依赖大厂生�?*，部署起来更自由�?
...
- 1. **手动部署** 需�?JDK17 + Python3.11 环境，支�?step-by-step 部署或一键脚本启动�?详细步骤见官方文�?& 视频演示�?
...
JD 这次还是超级给力的，如果你正�?*快速落地一个多智能体应�?*，JoyAgent-JDGenie 可以说是当前最值得一试的开源方案�?

---
title: "搞钱必备！github 这个神器能把视频/录音秒变小红书爆款文案!!"
permalink: 搞钱必备-github-这个神器能把视频录音秒变小红书爆款文案
...
    大家好，我是牛皮糖！今天介绍一款 Web 工具, 基于 AI 大模型, 一键将视频和音频转化为各种风格的文档, 无需登录注册, 前后端本地部署，以极低的成本体验 AI 视频/音频转风格文档服务。
...
### 🛠️ **超详细安装教程（小白友好版）**
**一句话总结**：用Docker一键安装，3步搞定！无需复杂配置，全程5分钟！
...
**🚀 第二步：一键部署AI视频助手**- 1. **打开命令行**（Windows用PowerShell，Mac/Linux用终端）
...
**🌐 第三步：打开浏览器使用**- 1. 访问 **http://localhost:8000**

- 2. **无需登录！** 直接上传视频/音频文件（支持MP4、MP3等常见格式）

- 3. 选择文档风格（小红书/公众号/思维导图等），点击“开始转换”

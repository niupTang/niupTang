---
title: "Github 开源如何友好的�?AI 获取到你的网站内容（内附爬虫列表�?
permalink: github-开源如何友好的�?ai-获取到你的网站内�?内附爬虫列表
...
大家好，我是牛皮糖！最近我看到好多做GEO 的文章，对于 AI 来说要如何才能要AI 收录你的网页�?其实AI 在网上找资料训练，其实也是要遵守一定的协议的，而这个协议就被我们定义在 robots.txt 文件中，当然你要通过 robots.txt 也能够组�?AI 爬虫你的网页�?
...
如果你的网站所有内容都希望�?AI 和其他爬虫索引，你的 `robots.txt` 文件可以这样写：
...
如果你只想让某个或某几个你信任的 AI 爬虫访问，可以明确指定它们。例如，如果你想允许 Google �?AI 爬虫（Google-Extended）和 OpenAI 的爬虫（GPTBot）访问，可以这样写：
...
假设你希�?AI 爬取你的大部分内容，但不想让它们访问后台管理、用户隐私等敏感目录，可以这样设置：
...
- •�?*实现友好爬取**：你需要自己创建一个 `robots.txt` 文件，使用 `Allow` 规则来明确告�?AI 爬虫它们可以访问你的网站。最简单的方式就是允许所有爬虫访问所有内容�?
...
AI 搜索爬虫
目前不明�?
AddSearchBot 是一个网络爬虫，�?AddSearch �?AI 驱动站点搜索解决方案索引网站内容
AI2Bot
Ai2�?
内容用于训练开放语言模型
未提供信�?
...
服务改进并为 Alexa 用户提供答案
未提供信�?
在通过 Alexa 呈现答案时包含被抓取网站的引�?
Andibot
Andi目前不明�?
使用生成�?AI 的搜索引擎，AI 搜索助手
未提供信�?
抓取网站并提�?AI 摘要
anthropic-ai
Anthropic目前不明�?
抓取数据以训�?Anthropic �?AI 产品
未提供信�?
抓取数据以训�?Anthropic 提供�?LLM �?AI 产品
Applebot
目前不明�?
目前不明�?
AI 搜索爬虫
...
Applebot-Extended
Apple�?
�?Siri、Spotlight、Safari、Apple Intelligence 提供支持
目前不明�?
用于训练�?Apple 产品提供支持的生成式 AI 功能的基础模型
Awario
Awario
目前不明�?
AI 数据抓取工具
...
�?Awario 运营�?AI 数据抓取工具
bedrockbot
Amazon是为自定�?AI 应用程序进行数据抓取
目前不明�?
连接并抓取用�?AWS bedrock 应用程序中选择使用�?URL
bigsur.ai
Big Sur AI
目前不明�?
AI 助手
目前不明�?
抓取网站内容以启�?AI 驱动的网络代理、销售助手和内容营销解决方案
Brightbot 1.0
Browsing.ai
目前不明�?
LLM/AI 训练
目前不明�?
抓取数据以训练专注于网站客户支持�?LLM �?AI 产品
Bytespider
ByteDance
�?
LLM 训练
目前不明�?
下载数据以训�?LLMS，包�?ChatGPT 的竞争对�?
CCBot
Common Crawl Foundation是提供开放抓取数据集，用于机器学�?AI
目前每月一�?
可追溯到 2008 年的网络存档，每年被数千篇研究论文引�?
ChatGPT Agent
OpenAI�?
AI 代理
目前不明�?
OpenAI 创建�?AI 代理，可以使�?Web 浏览器智能地导航和与网站交互
ChatGPT-User
OpenAI�?
根据用户提示采取行动
仅在用户提示�?
�?ChatGPT 中的插件使用，根据用户输入回答查�?
Claude-SearchBot
Anthropic是提高用户的搜索结果质量
未提供信�?
浏览网络并分析在线内容以增强搜索响应的相关性和准确�?
Claude-User
Anthropic是支�?Claude AI 用户
未提供信�?
...
未公开记录�?AI 代理
目前不明�?
�?Anthropic 运营�?AI 相关代理，确切用途尚不清�?
ClaudeBot
Anthropic是抓取数据以训练 Anthropic �?AI 产品
未提供信�?
抓取数据以训�?Anthropic 提供�?LLM �?AI 产品
CloudVertexBot
目前不明�?
...
AI 数据抓取工具
目前不明�?
Google 运营的爬虫，可供站点所有者请求针对其站点进行定向抓取以用�?Vertex AI 平台
cohere-ai
Cohere目前不明�?
检索数据以提供对用户发起提示的响应
根据用户提示采取行动
...
AI 助手
目前不明�?
�?DuckDuckGo �?DuckAssist 功能用于获取内容并生成用户搜索的实时 AI 答案
Echobot Bot
Echobox
目前不明�?
AI 数据抓取工具
目前不明�?
�?Echobox 运营�?AI 数据抓取工具
EchoboxBot
Echobox目前不明�?
数据收集以支�?AI 驱动的产�?
目前不明�?
...
facebookexternalhit
Meta/Facebook
否表面上仅用于分享，但很可能也用�?AI 爬虫
目前不明�?
抓取�?Meta 系列应用上分享的应用程序或网站的内容
Factset_spyderbot
Factset目前不明�?
AI 模型训练
未提供信�?
...
AI 助手
目前不明�?
负责收集和扫�?Google Gemini 深度研究功能所用资源的代理
Google-CloudVertexBot
Google
是为采用 Vertex AI 的企业构建和管理 AI 模型
无信�?
在构�?Vertex AI 代理时根据站点所有者的请求抓取站点
Google-Extended
Google
是LLM 训练
无信�?
用于训练 Gemini �?Vertex AI 生成�?API
Google-Firebase
Google
目前不明�?
用作 Google Firebase AI 产品用户开发的 AI 应用程序的一部分
目前不明�?
支持 Google �?Firebase AI 产品
GoogleAgent-Mariner
Google
目前不明�?
AI 代理
目前不明�?
Google 创建�?AI 代理，可以使�?Web 浏览器智能导�?
GoogleOther
Google
是抓取数�?
无信�?
...
AI 数据抓取工具
目前不明�?
�?netEstate 运营�?AI 数据抓取工具
NovaAct
目前不明�?
目前不明�?
AI 代理
目前不明�?
Amazon 创建�?AI 代理，可以使�?Web 浏览器智能导�?
OAI-SearchBot
OpenAI是搜索结果生�?
无信�?
抓取站点以在 SearchGPT 中作为结果呈�?
omgili
Webz.io是数据被出售
无信�?
�?API 抓取站点，数据也出售用于研究目的�?LLM 训练
omgilibot
Webz.io是数据被出售
无信�?
最初用�?Omgili 搜索引擎的旧用户代理
OpenAI
OpenAI�?
目前不明�?
目前不明�?
...
AI 代理
目前不明�?
OpenAI 创建�?AI 代理，可以使�?Web 浏览器智能导�?
PanguBot
中国公司华为
目前不明�?
AI 数据抓取工具
目前不明�?
用于为其多模�?LLM PanGu 下载训练数据
Panscient
Panscient是使用机器学习和 AI 进行数据收集和分�?
对同一域名�?IP 最多每秒请求一�?
...
使用 AI 和机器学习构建有关企业和商业专业人士的结构化数据
Perplexity-User
Perplexity否用于响应用户请求回答查�?
仅在用户提示�?
访问网页以帮助提供准确答案并在响应中包含链接
PerplexityBot
Perplexity是搜索结果生�?
无信�?
抓取站点以在 Perplexity 中作为结果呈�?
PetalBot
Huawei�?
在华为助手和 AI 搜索服务中提供推�?
未明确提供频�?
...
支持 AI 产品
未明确提供频�?
�?Qualified 作为�?AI 产品套件的一部分运营
QuillBot
Quillbot目前不明�?
提供 AI 检测、写作工具和其他服务
未明确提供频�?
�?QuillBot 作为�?AI 产品套件的一部分运营
quillbot.com
Quillbot目前不明�?
提供 AI 检测、写作工具和其他服务
未明确提供频�?
�?QuillBot 作为�?AI 产品套件的一部分运营
SBIntuitionsBot
SB Intuitions是将收集的数据用�?AI 开发和信息分析
无信�?
AI 开发和信息分析
Scrapy
Zyte目前不明�?
...
大约�?10 秒一�?
收集的数据用�?ContentShake AI 工具报告
SemrushBot-SWA
Semrush是检查用�?SEO Writing Assistant �?URL
大约�?10 秒一�?
检�?URL 是否可访�?
ShapBot
Parallel是为 Parallel �?Web API 收集数据
目前不明�?
帮助发现和索引网站以用于 Parallel �?Web API
...
Velen Crawler是抓取数据用于业务数据集和机器学习模�?
无信�?
...
AI 数据抓取工具
目前不明�?
�?WEBSPARK 运营�?AI 数据抓取工具
Webzio-Extended
目前不明�?
目前不明�?
AI 数据抓取工具
目前不明�?
用于维护出售给其他公司的网络抓取数据存储�?
wpbot
QuantumCloud目前不明�?
实时聊天支持和潜在客户生�?
目前不明�?
支持 WordPress �?AI 聊天机器人插件的功能
YaK
Meltwater目前不明�?
支持 AI 的消费者情报套�?
目前不明�?
检索用�?Meltwater 支持 AI 的消费者情报套件的数据
YandexAdditional
Yandex是为 YandexGPT LLM 抓取/分析数据
无信�?
检索用�?YandexGPT 快速回答功能的数据
YandexAdditionalBot
Yandex是为 YandexGPT LLM 抓取/分析数据
无信�?
检索用�?YandexGPT 快速回答功能的数据

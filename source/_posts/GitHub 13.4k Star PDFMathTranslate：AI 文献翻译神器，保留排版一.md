...
![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrRlTFoFiazugtWx85gv2NcOPf6iaib82iag2VrRSVj1Z4ThWtCWzvibMCzr84lVzxNFz3VN7tgHfNKvJGw/640?wx_fmt=png&from=appmsg)

**🚀 快速阅读：**

- 1. **PDFMathTranslate** 是一款开源的 PDF 文档翻译工具，支持科技论文�?PDF 文件的翻译，保留原文排版，包括公式和图表�?

- ![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrRlTFoFiazugtWx85gv2NcOPpN9H5VBn83W281T8o09HDFN3jZaULupHLR4wn13A2OXk7mr98P861A/640?wx_fmt=png&from=appmsg)

- 2. 支持双语对照，保持原有目录结构，兼容多种翻译服务，如 Google、DeepL、Ollama �?OpenAI 等�?

- 3. 可通过命令行工具进行操作，实现文档的快速翻译和双语对照查看�?

- ![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrRlTFoFiazugtWx85gv2NcOPrWaYKicPjxic0bSydIqFo5ibfwXQBmw52BjKYpSwH3PxXQTb7l5ibjRVHQ/640?wx_fmt=png&from=appmsg)

**PDFMathTranslate 是什么：**

** ****PDFMathTranslate**是一款开源的 PDF 文档翻译工具，设计用于翻译科技论文�?PDF 文件。它能保留原文的排版，包括公式和图表，支持双语对照，保持原有目录结构，兼容多种翻译服务，�?Google、DeepL、Ollama �?OpenAI 等。用户基于命令行工具操作，实现文档的快速翻译和双语对照查看�?

**PDFMathTranslate 的主要功能：**

- •�?*保留原排�?*�?*PDFMathTranslate**能完整保�?PDF 文档中的公式、图表和目录结构，确保翻译后的文档与原文版式一致�?
...
- •�?*多种翻译服务支持**：兼�?Google、DeepL、Ollama、OpenAI 等多种翻译服务，用户可以根据需求选择�?

**如何运行 PDFMathTranslate�?* 安装要求 Python 版本 >=3.8, <=3.12，使用以下命令安装：

`pip install pdf2zh`在命令行中执行翻译指令，在工作目录下生成翻译文档 `example-zh.pdf` 和双语对照文档 `example-dual.pdf`，默认使�?Google 作为翻译服务�?

项目地址�?

https://github.com/Byaidu/PDFMathTranslate

也可以在线体�?https://pdf2zh.com/

![](https://mmbiz.qpic.cn/mmbiz_gif/7ibzJsmgW5wguO21SlkBAdxJgAicEOVCzDiaObyzEAEMTI527clib7gHvKfBtDu8MJZLwwEIVuVBmqfn01fmLDdTfQ/640?wx_fmt=gif&tp=webp&wxfrom=5&wx_lazy=1)

·················END·················

最近雨飞大佬的AI 大模型交流群免费对外开放了,又想进去交流答疑的可以私聊我"swdk980324"

---
title: "开源视频生成新纪元：Open-Sora让每个人都能创作Sora级视�?
permalink: 开源视频生成新纪元-open-sora让每个人都能创作sora级视�?
...
大家好，我是牛皮糖！chatGPT �?Sora2 已经火了很久了，今天在GitHub 上看到一款针对于 Sora 的开源项目，Colossal-AI团队正式开源了**Open-Sora**项目，这是一个致力于复现OpenAI Sora视频生成模型的完整开源解决方案。该项目不仅提供了完整的训练代码和模型架构，还包含了数据预处理、推理展示等全套工具链，让普通研究者和开发者也能参与到视频生成技术的研究中来�?
...
在VBench上，Open-Sora 2.0 显著缩小了与 OpenAI �?Sora 的差距，�?Open-Sora 1.2 相比，差距从 4.52% �?0.69%�?
...
**高效的训练优�?* 基于Colossal-AI的深度学习优化技术，Open-Sora在训练效率上做了大量优化，支持混合精度训练、梯度检查点等技术，大幅降低了训练成本�?

**灵活的配置系�?* 通过配置文件，用户可以轻松调整模型参数、训练策略和推理设置，无需修改代码即可进行各种实验�?

**虽然Open-Sora在复现Sora能力方面取得了显著进展，但与原始Sora相比，在生成视频的时长、质量和一致性方面仍有差距。项目团队也坦诚表示，这还是一�?进行中的工作"�?*

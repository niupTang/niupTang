...
    大家好，我是牛皮糖！我本身是一�?Java 开发工程师，看了一�?Github 里面有很�?Java 学习资料，但是大多数都是为面试准备的，要说有没有那种从零开始的，其�?B �?上黑马程序员�?Java �?尚硅谷的Java 课程都可以�?没收广告费用�?。个人的学习经验是视频配合书本加上实践�?
...
    GitHub 上面这开源的大数据学习指�?2.6 k�?Stars，文章从安装JDK 到大数据实战，对于新手小白都可以去看看�?
...
**     **实战开源我比较推荐 江南一点雨�?微人�?27.3 k Stars,微人事是一个前后端分离的人力资源管理系统，项目采用 SpringBoot+Vue 开发，项目加入常见的企业级应用所涉及到的技术点，例�?Redis、RabbitMQ 等。还配置了对应的 视频教程，同时江南一点雨还有不少的其他视频教程�?

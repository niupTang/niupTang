---
title: "Github 一天新�?k Stars 的项目是什么？"
permalink: "github-一天新�?k-stars-的项目是什�?"
...
    大家好，我是牛皮糖！今天在GitHub 的Trending 上看到了一天新增了 1215 Stars 的项目利�?LLM 和计算机视觉实现基于浏览器的工作流程自动化�?
...
- 2FA 代理：此代理负责填写网站上的 2FA 表单。它能够拦截网站�?2FA 请求，并请求用户定义�?2FA 代码 API 或等待用户输�?2FA 代码，然后完成登录过程�?

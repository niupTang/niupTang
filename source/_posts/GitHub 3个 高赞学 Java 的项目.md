...
    大家好，我是牛皮糖！我本身是一名 Java 开发工程师，看了一下 Github 里面有很多 Java 学习资料，但是大多数都是为面试准备的，要说有没有那种从零开始的，其实 B 站 上黑马程序员的 Java 和 尚硅谷的Java 课程都可以。(没收广告费用哈)。个人的学习经验是视频配合书本加上实践。

    

![](https://mmbiz.qpic.cn/mmbiz_jpg/p1ESIQQvfrQ7jUMgZSBNicOPgLkav96Fs8GRqkbJsPcib77W3TX4FxuDtzDVibvuAeuxGla1cJvuQB4iaZPVjT8rwQ/640?wx_fmt=jpeg&from=appmsg)

**大数据学习指南**

    GitHub 上面这开源的大数据学习指南 2.6 k的 Stars，文章从安装JDK 到大数据实战，对于新手小白都可以去看看。
...
**    **对于 GitHub 上面最高赞的学习资料 JavaGuide 146K Stars, 是开源的Java 面试宝典。相对深入的学习 Java 的基础和源码，八股文宝典。

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrQ7jUMgZSBNicOPgLkav96FsuicWyv7gXKV9cJBfl79xzIxZZwNUiaDVw8XojD6QJg8gaGtRWz0kiaZGw/640?wx_fmt=png&from=appmsg)

**实战开源项目**

**     **实战开源我比较推荐 江南一点雨的 微人事 27.3 k Stars,微人事是一个前后端分离的人力资源管理系统，项目采用 SpringBoot+Vue 开发，项目加入常见的企业级应用所涉及到的技术点，例如 Redis、RabbitMQ 等。还配置了对应的 视频教程，同时江南一点雨还有不少的其他视频教程。

**https://github.com/lenve/vhr******

  Java 项目在国内太多的学习资料了，很多博客大佬写了很多实践项目。

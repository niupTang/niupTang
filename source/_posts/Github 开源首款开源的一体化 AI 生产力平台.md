---
title: Github 开源首款开源的一体化 AI 生产力平�?
...
大家好，我是牛皮糖！今天给大家带来一个AI MI平台�?GitHub 项目 ——�?*Magic**�?.4k⭐），它被称为“首款开源的一体化 AI 生产力平台�?可以统计企业内部消息、将人和人之间的消息统计整理，功能强大得让人忍不住惊呼一句：**“这是生产倒逼人升级的节奏！�?*
...
## 项目简�?
**Magic** 是由 GitHub 用户 `dtyq` 开源的 **端到�?AI 生产力平�?*，它整合了智能代理、工作流引擎、IM 聊天、在线协作文档等多个功能模块，构成了一个完整的企业�?AI 应用生态�?GitHub)

官网一眼就能看到其愿景：让企业 “快速构建部�?AI 应用，产能提�?100 倍”——听起来就让人充满期待�?
...
- •�?*Super Magic** 通用�?AI 智能体，支持“理解指�?�?规划任务 �?执行操作 �?修正错误”的完整流程，自主性十足�?
...
- •�?*Magic Flow** 可视�?AI 工作流编排平台，能高效串联多个模块协作完成任务�?
...
- •�?*Teamshare OS**（即将发布） �?AI 助力的在线协作办公平台，包括文档、表格、任务板和知识管理，目标全面替代传统办公系统�?

此外，还有支撑工具如 **Agentlang**（自然语言 AI 代理框架）�?*Magic Lens**（HTML �?Markdown 工具）等完善生态�?
...
- 3. 配置 AI 模型环境变量 `.env` 与 `.env_super_magic`，确保至少有一�?LLM 可用�?
...
## 为什么推�?Magic
总结一下，**Magic 就像给企业注入了“智能大脑�?*，不仅能协助办公、管理、研发等，更�?AI 工具集成与自动化方面迈出了一大步。对于想提升协作效率、拥�?AI 助力的团队来说，这简直是一个神器级开源项目！

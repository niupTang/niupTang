...
    大家好，我是牛皮糖！最近大模型老火了，给大家发个福利，认识几个AI 大佬拉了个群，现在已经200多号人了,打算正式对外开放。
...
- 
`群规``
``- 禁止聊政治相关话题、与政治相关技术话题也禁止，如有违规直接移除。``- 欢迎群友抛出一些技术问题进行探讨，但禁止不携带上下文随意提问（很多提问可以先检索一波）。``- 群里提问，请进行信息整合，禁止刷屏，禁止连续刷屏，为大家营造舒适的群聊环境。``- 欢迎大家踊跃发言，对不同技术提出不同看法，但请注意语言表达方式，禁止扒高踩低。``- 为了给大家提供一个友好的交流环境，禁止在群里“对线”，我们应该友好交流。``- 禁止发广告，尤其是卖课等割韭菜广告。``- 如果别人解答了你的问题，请表示感谢，也可以发红包。``- 禁止爆粉，一经发现，全网拉黑。``
`

    群满200人没法扫了，请加我微信"swdk980324"，邀你进群。本群是单纯的技术交流群，请尊重各位群友。

![](https://mmbiz.qpic.cn/mmbiz_png/p1ESIQQvfrSntf7iac2gOxZRbaAEnibTCxwQ3KIibQIz0nX8Fc763Sw4UQ5sLjLArW8ehafcSsGQCzU9iboOIELv8g/640?wx_fmt=png&from=appmsg)
